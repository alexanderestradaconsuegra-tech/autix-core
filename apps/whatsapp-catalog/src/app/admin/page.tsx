...
function AdminDashboard({ session }: { session: Session }) {
  ...
  const [tab, setTab] = useState<'negocio' | 'productos'>('negocio');
  ...
  return (
    <main className="min-h-dvh bg-neutral-50 pb-16">
      ...
      <div className="mx-auto max-w-2xl px-4 py-3">
        <div className="mb-4 flex gap-2">
          <button
            ...
            className={`rounded-full px-3.5 py-1.5 text-xs font-medium ${
              tab === 'negocio' ? 'bg-neutral-900 text-white' : 'bg-neutral-100 text-neutral-600'
            }`}
          >
            Negocio
          </button>
          <button
            ...
            className={`rounded-full px-3.5 py-1.5 text-xs font-medium ${
              tab === 'productos' ? 'bg-neutral-900 text-white' : 'bg-neutral-100 text-neutral-600'
            }`}
          >
            Productos
          </button>
        ...
        {tab === 'negocio' ? (
          <BusinessTab business={business} onBusinessUpdated={setBusiness} />
        ) : (
